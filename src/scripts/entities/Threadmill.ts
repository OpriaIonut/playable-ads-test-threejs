...
export class Threadmill
{
    ...
    private curvePoints = [ //Anchor points used to initialize the curve
        //Bottom lane
        new Vector3(-1, 0.35, 0.45),
        new Vector3(1.0, 0.35, 0.45),
        new Vector3(1.3, 0.35, 0.35),

        //Right lane
        new Vector3(1.4, 0.35, 0),
        new Vector3(1.4, 0.35, -2),
        new Vector3(1.3, 0.35, -2.65),

        //Top lane
        new Vector3(1, 0.35, -2.75),
        new Vector3(-1, 0.35, -2.75),
        new Vector3(-1.3, 0.35, -2.65),

        //Left lane
        new Vector3(-1.4, 0.35, -2),
        new Vector3(-1.4, 0.35, -0.25)
    ];
